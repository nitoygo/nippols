...
import { ShowButton, ListButton, DeleteButton, RefreshButton } from 'react-admin';
...
class TaskEditActions extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    const { basePath, data, resource, hasShow, refresh } = this.props;
